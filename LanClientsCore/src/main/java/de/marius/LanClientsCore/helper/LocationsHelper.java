...
public class LocationsHelper {
    ...
    public static final String LAN_CLIENTS_DB = "lanclients.db";
    ...
    public static Path getLanClientsDbPath(){
        return getLanClientsHomeDirectory().resolve("data").resolve(LAN_CLIENTS_DB);
    }
}
